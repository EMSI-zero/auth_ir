...
```
go build -ldflags "-X github.com/emsi-zero/auth_ir/cmd.Version=`git rev-parse HEAD`"
GOOS=linux GOARCH=arm64 go build -ldflags "-X github.com/emsi-zero/auth_ir/cmd.Version=`git rev-parse HEAD`" -o gotrue-arm64
```
...
[Releases](https://github.com/emsi-zero/auth_ir/releases) and [Security
Advisories](https://github.com/emsi-zero/auth_ir/security/advisories) sections.
...
For apple specific setup see: <https://github.com/emsi-zero/auth_ir#apple-oauth>
