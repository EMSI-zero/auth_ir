...
FLAGS=-ldflags "-X github.com/emsi-zero/auth_ir/internal/utilities.Version=`git describe --tags`" -buildvcs=false
ifdef RELEASE_VERSION
	FLAGS=-ldflags "-X github.com/emsi-zero/auth_ir/internal/utilities.Version=v$(RELEASE_VERSION)" -buildvcs=false
endif
